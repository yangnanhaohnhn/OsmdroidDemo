...
public class OfflineTileProvider extends MapTileProviderArray implements IMapTileProviderCallback {
    ...
    public OfflineTileProvider(final IRegisterReceiver pRegisterReceiver, File[] source) {
        this(pRegisterReceiver, source, false);
    }
     ...
     * throws with the source[] is null or empty
     */
    public OfflineTileProvider(final IRegisterReceiver pRegisterReceiver, File[] source, final boolean ignoreTileSource) {
        ...
        final MapTileFileArchiveProvider mapTileFileArchiveProvider = new MapTileFileArchiveProvider(pRegisterReceiver, getTileSource(), archives, ignoreTileSource);
