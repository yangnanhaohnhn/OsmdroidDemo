...
public class MainActivity extends AppCompatActivity {
    ...
    private final String[] typeName = {
            ...
            "百度-矢量", "百度-影像",
            "腾讯-矢量", "腾讯-影像", "腾讯-地形",
            "arcGis", "OSM_矢量", "离线-数据","谷歌-矢量","谷歌-影像"
    };
...
//        curLocationMarker = new Marker(mvView);
//        curLocationMarker.setIcon(getResources().getDrawable(R.mipmap.ic_my_location));
//        curLocationMarker.setAnchor(Marker.ANCHOR_CENTER, Marker.ANCHOR_CENTER);
//        curLocationMarker.setInfoWindow(null);
//        curLocationMarker.setId("locationMarkerId");
//        curLocationMarker.setTitle("locationMarkerId");
//        mvView.getOverlays().add(1, curLocationMarker);
